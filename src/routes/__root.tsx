...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.conference-wihcn.xyz/Logo.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@wihcnetwork" },
      { name: "twitter:image", content: "https://www.conference-wihcn.xyz/Logo.png" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", href: "/Favicon2.jpg", type: "image/jpeg" },
    ],
  }),
